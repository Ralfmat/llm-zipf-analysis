...
# --- 1. PRZYGOTOWANIE DANYCH AI (KOTWICA) ---
...
ai_count = len(ai_tokens)  # To jest nasze N (długość próbki)
...
# --- 2. PRZYGOTOWANIE DANYCH LUDZKICH (SAMPLING) ---
...
# Tokenizujemy całą książkę raz, żeby łatwo wycinać fragmenty
...
for i in range(NUM_SAMPLES):
    ...
    # Wycinamy ciągły fragment o długości dokładnie takiej jak AI
...
# WYKRES 3: KONFRONTACJA (AI na tle Dune)
ax3 = axes[1, 0]
# ZMIANA: Dodano N do legendy
...
# WYKRES 4: Parametry Alpha (Słupki)
ax4 = axes[1, 1]
labels = ['Idealny Zipf', 'Dune (Średnia)', 'AI']
# ZMIANA: Wartość 2.0 dla Idealnego Zipfa
